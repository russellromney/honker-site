...
The worker loop waits on the database's write-ahead log and wakes within 1-2 ms when a new job lands. No polling.
...
- [Scheduler](/guides/scheduler/) for cron-style periodic tasks

...
func init() {
    // Go modules can't ship a binary, so this reads
    // HONKER_EXTENSION_PATH or finds the extension next to your binary.
    // Download it from a release or build it from the repo.
